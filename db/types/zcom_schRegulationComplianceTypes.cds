...
aspect Enterprise {
    ...
    fuelOnwardMaterialDocNoDocumentType                : DocumentType @title: '{i18n>FuelOnwardMaterialDocType}';
    fuelOnwardMaterialDocNoGeneralDocumentNumber       : String(10)   @title: '{i18n>FuelOnwardMaterialGenDocNoNumber}';
    fuelOnwardMaterialDocNoDocumentItemNumber          : String(6)    @title: '{i18n>FuelOnwardMaterialDocNoItemNumber}';
    fuelOnwardMaterialDocNoDocumentSubItem             : String(6)    @title: '{i18n>FuelOnwardMaterialDocSubItem}';
    fuelOnwardMaterialDocNoMaterialDocumentYear        : String(4)    @title: '{i18n>FuelOnwardMaterialDocYear}';
    fuelReversalMaterialDocNoDocumentType              : DocumentType @title: '{i18n>FuelReversalMaterialDocType}';
    fuelReversalMaterialDocNoGeneralDocumentNumber     : String(10)   @title: '{i18n>FuelReversalMaterialGenDocNumber}';
    fuelReversalMaterialDocNoDocumentItemNumber        : String(6)    @title: '{i18n>FuelReversalMaterialDocItemNumber}';
    fuelReversalMaterialDocNoDocumentSubItem           : String(6)    @title: '{i18n>FuelReversalMaterialDocSubItem}';
    fuelReversalMaterialDocNoMaterialDocumentYear      : String(4)    @title: '{i18n>FuelReversalMaterialDocYear}';
    ...
    renewableDeliveryDocNoDocumentType                 : DocumentType @title: '{i18n>RenewableDeliveryDocType}';
    renewableDeliveryDocNoGeneralDocumentNumber        : String(10)   @title: '{i18n>RenewableDeliveryGenDocNumber}';
    renewableDeliveryDocNoDocumentItemNumber           : String(6)    @title: '{i18n>RenewableDeliveryDocItemNumber}';
    renewableDeliveryDocNoDocumentSubItem              : String(6)    @title: '{i18n>RenewableDeliveryDocSubItem}';
    renewableDeliveryDocNoMaterialDocumentYear         : String(4)    @title: '{i18n>RenewableDeliveryMaterialDocYear}';
    renewableMaterialDocNoDocumentType                 : DocumentType @title: '{i18n>RenewableMaterialDocType}';
    renewableMaterialDocNoGeneralDocumentNumber        : String(10)   @title: '{i18n>RenewableMaterialGenDocNumber}';
    renewableMaterialDocNoDocumentItemNumber           : String(6)    @title: '{i18n>RenewableMaterialDocItemNumber}';
    renewableMaterialDocNoDocumentSubItem              : String(6)    @title: '{i18n>RenewableMaterialDocSubItem}';
    renewableMaterialDocNoMaterialDocumentYear         : String(4)    @title: '{i18n>RenewableMaterialDocYear}';
    renewableReverseMaterialDocNoDocumentType          : DocumentType @title: '{i18n>RenewableReverseMaterialDocType}';
    renewableReverseMaterialDocNoGeneralDocumentNumber : String(10)   @title: '{i18n>RenewableReverseMaterialGenDocNumber}';
    renewableReverseMaterialDocNoDocumentItemNumber    : String(6)    @title: '{i18n>RenewableReverseMaterialDocItemNumber}';
    renewableReverseMaterialDocNoDocumentSubItem       : String(6)    @title: '{i18n>RenewableReverseMaterialDocSubItem}';
    renewableReverseMaterialDocNoMaterialDocumentYear  : String(4)    @title: '{i18n>RenewableReverseMaterialDocYear}';
    sourceOrgCompanyCode                               : String(4)    @assert.unique  @title: '{i18n>sourceOrgCompanyCompanyCode}';
    sourceOrgCompanyPlant                              : String(4)    @title: '{i18n>sourceOrgCompanyPlant}';
    sourceOrgCompanyStorageLocation                    : String(4)    @title: '{i18n>sourceOrgCompanyStorageLocation}';
    sourceOrgCompanyMaterialNumber                     : String(40)   @title: '{i18n>sourceOrgCompanyMaterialNumber}';
    sourceOrgCompanyMaterialNumberDesc                 : String(100)  @title: '{i18n>sourceOrgCompanyMaterialNumberDesc}';
    sourceOrgCompanyCountryKey                         : String(10)   @title: '{i18n>sourceOrgCompanyCountryKey}';
    sourceOrgCompanyRegion                             : String(3)    @title: '{i18n>sourceOrgCompanyRegion}';
    destinationOrgCompanyCode                          : String(4)    @assert.unique  @title: '{i18n>destinationOrgCompanyCode}';
    destinationOrgCompanyPlant                         : String(4)    @title: '{i18n>destinationOrgCompanyPlant}';
    destinationOrgCompanyStorageLocation               : String(4)    @title: '{i18n>destinationOrgCompanyStorageLocation}';
    destinationOrgCompanyMaterialNumber                : String(40)   @title: '{i18n>destinationOrgCompanyMaterialNumber}';
    destinationOrgCompanyCountryKey                    : String(10)   @title: '{i18n>destinationOrgCompanyCountryKey}';
    destinationOrgCompanyRegion                        : String(3)    @title: '{i18n>destinationOrgCompanyRegion}';
    fuelLogisticsCompanyCode                           : String(4)    @assert.unique  @title: '{i18n>fuelLogisticsCompanyCode}';
    fuelLogisticsCompanyPlant                          : String(4)    @title: '{i18n>fuelLogisticsCompanyPlant}';
    fuelLogisticsCompanyStorageLocation                : String(4)    @title: '{i18n>fuelLogisticsCompanyStorageLocation}';
    fuelLogisticsCompanyMaterialNumber                 : String(40)   @title: '{i18n>fuelLogisticsCompanyMaterialNumber}';
    fuelLogisticsCompanyMaterialNumberDesc             : String(100)  @title: '{i18n>fuelLogisticsCompanyMaterialNumberDesc}';
    fuelLogisticsCompanyCountryKey                     : String(10)   @title: '{i18n>fuelLogisticsCompanyCountryKey}';
    fuelLogisticsCompanyRegion                         : String(3)    @title: '{i18n>fuelLogisticsCompanyRegion}';
    regulationLogisticsCompanyCode                     : String(4)    @assert.unique  @title: '{i18n>regulationLogisticsCompanyCode}';
    regulationLogisticsCompanyPlant                    : String(4)    @title: '{i18n>regulationLogisticsCompanyPlant}';
    regulationLogisticsCompanyStorageLocation          : String(4)    @title: '{i18n>regulationLogisticsCompanyStorageLocation}';
    regulationLogisticsCompanyMaterialNumber           : String(40)   @title: '{i18n>regulationLogisticsCompanyMaterialNumber}';
    regulationLogisticsCompanyMaterialNumberDes        : String(100)  @title: '{i18n>regulationLogisticsCompanyMaterialNumberDes}';
    regulationLogisticsCompanyCountryKey               : String(10)   @title: '{i18n>regulationLogisticsCompanyCountryKey}';
    regulationLogisticsCompanyRegion                   : String(3)    @title: '{i18n>regulationLogisticsCompanyRegion}';
