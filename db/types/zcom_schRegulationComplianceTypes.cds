...
aspect Enterprise {
    ...
    rfDeliveryDocumentType                 : DocumentType @title: '{i18n>RfInboundDeliveryDocType}';
    rfDeliveryGeneralDocumentNumber        : String(10)   @title: '{i18n>RfInboundDeliveryGenDocNumber}';
    rfDeliveryDocumentItemNumber           : String(6)    @title: '{i18n>RfInboundDeliveryDocItemNumber}';
    rfDeliveryDocumentSubItem              : String(6)    @title: '{i18n>RfInboundDeliveryDocSubItem}';
    rfDeliveryMaterialDocumentYear         : String(4)    @title: '{i18n>RfInboundDeliveryMaterialDocYear}';
    ...
    renewableOrderDocumentType                  : DocumentType @title: '{i18n>RenewableOrderDocType}';
    renewableOrderGeneralDocumentNumber         : String(10)   @title: '{i18n>RenewableOrderGenDocNumber}';
    renewableOrderDocumentItemNumber            : String(6)    @title: '{i18n>RenewableOrderDocItemNumber}';
    renewableOrderDocumentSubItem               : String(6)    @title: '{i18n>RenewableOrderDocSubItem}';
    renewableOrderMaterialDocumentYear          : String(4)    @title: '{i18n>RenewableOrderMaterialDocYear}';
