...
import type { MaintainIdRangeForReconciliationGroupApi } from './MaintainIdRangeForReconciliationGroupApi';
import {
...
/**
 * This class represents the entity "MaintainIdRangeForReconciliationGroup" of service "RegulationComplianceMasterService".
 */
export class MaintainIdRangeForReconciliationGroup<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements MaintainIdRangeForReconciliationGroupType<T>
{
  /**
   * Technical entity name for MaintainIdRangeForReconciliationGroup.
   */
  static _entityName = 'MaintainIdRangeForReconciliationGroup';
  /**
   * Default url path for the according service.
   */
  static _defaultBasePath = '/service/RegulationComplianceMasterService';
  /**
   * All key fields of the MaintainIdRangeForReconciliationGroup entity
   */
  ...
  /**
   * One-to-one navigation property to the {@link MaintainIdRangeForReconciliationGroup} entity.
   */
  declare siblingEntity?: MaintainIdRangeForReconciliationGroup<T> | null;

  constructor(_entityApi: MaintainIdRangeForReconciliationGroupApi<T>) {
    super(_entityApi);
  }
}

export interface MaintainIdRangeForReconciliationGroupType<
  T extends DeSerializers = DefaultDeSerializers
> {
  ...
  siblingEntity?: MaintainIdRangeForReconciliationGroupType<T> | null;
}
