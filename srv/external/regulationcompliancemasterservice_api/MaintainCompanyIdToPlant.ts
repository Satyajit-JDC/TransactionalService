...
import type { MaintainCompanyIdToPlantApi } from './MaintainCompanyIdToPlantApi';

/**
 * This class represents the entity "MaintainCompanyIdToPlant" of service "RegulationComplianceMasterService".
 */
export class MaintainCompanyIdToPlant<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements MaintainCompanyIdToPlantType<T>
{
  /**
   * Technical entity name for MaintainCompanyIdToPlant.
   */
  static _entityName = 'MaintainCompanyIdToPlant';
  /**
   * Default url path for the according service.
   */
  static _defaultBasePath = '/service/RegulationComplianceMasterService';
  /**
   * All key fields of the MaintainCompanyIdToPlant entity
   */
  ...
  /**
   * One-to-one navigation property to the {@link MaintainCompanyIdToPlant} entity.
   */
  declare siblingEntity?: MaintainCompanyIdToPlant<T> | null;

  constructor(_entityApi: MaintainCompanyIdToPlantApi<T>) {
    super(_entityApi);
  }
}

export interface MaintainCompanyIdToPlantType<
  T extends DeSerializers = DefaultDeSerializers
> {
  ...
  siblingEntity?: MaintainCompanyIdToPlantType<T> | null;
}
