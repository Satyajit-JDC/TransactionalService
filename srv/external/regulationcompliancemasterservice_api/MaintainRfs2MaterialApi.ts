...
import { MaintainRfs2MaterialRequestBuilder } from './MaintainRfs2MaterialRequestBuilder';
...
export class MaintainRfs2MaterialApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<MaintainRfs2Material<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): MaintainRfs2MaterialApi<DeSerializersT> {
    return new MaintainRfs2MaterialApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    REGULATION_TYPE: OneToOneLink<
      MaintainRfs2Material<DeSerializersT>,
      DeSerializersT,
    ...
    D_CODE: OneToOneLink<
      MaintainRfs2Material<DeSerializersT>,
      DeSerializersT,
      Rfs2FuelCodeApi<DeSerializersT>
    >;
    /**
  ...
  entityConstructor = MaintainRfs2Material;

  requestBuilder(): MaintainRfs2MaterialRequestBuilder<DeSerializersT> {
    return new MaintainRfs2MaterialRequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<MaintainRfs2Material<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    ID: OrderableEdmTypeField<
      MaintainRfs2Material<DeSerializers>,
      DeSerializersT,
      'Edm.Guid',
      false,
      true
    ...
    SIBLING_ENTITY: OneToOneLink<
      ...
      MaintainRfs2MaterialApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<MaintainRfs2Material<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        YEAR: fieldBuilder.buildEdmTypeField('year', 'Edm.String', true),
        /**
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', MaintainRfs2Material)
      };
    }
