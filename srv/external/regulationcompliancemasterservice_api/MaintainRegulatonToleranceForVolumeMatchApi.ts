...
import { MaintainRegulatonToleranceForVolumeMatchRequestBuilder } from './MaintainRegulatonToleranceForVolumeMatchRequestBuilder';
...
export class MaintainRegulatonToleranceForVolumeMatchApi<
    ...
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): MaintainRegulatonToleranceForVolumeMatchApi<DeSerializersT> {
    return new MaintainRegulatonToleranceForVolumeMatchApi(deSerializers);
  }
  ...
  entityConstructor = MaintainRegulatonToleranceForVolumeMatch;

  requestBuilder(): MaintainRegulatonToleranceForVolumeMatchRequestBuilder<DeSerializersT> {
    return new MaintainRegulatonToleranceForVolumeMatchRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof MaintainRegulatonToleranceForVolumeMatch,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    ID: OrderableEdmTypeField<
      MaintainRegulatonToleranceForVolumeMatch<DeSerializers>,
      DeSerializersT,
      'Edm.Guid',
      false,
      true
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', MaintainRegulatonToleranceForVolumeMatch)
      };
    }
