...
import { MaintainInventoryPostingPlantRequestBuilder } from './MaintainInventoryPostingPlantRequestBuilder';
...
export class MaintainInventoryPostingPlantApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<MaintainInventoryPostingPlant<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): MaintainInventoryPostingPlantApi<DeSerializersT> {
    return new MaintainInventoryPostingPlantApi(deSerializers);
  }
  ...
  entityConstructor = MaintainInventoryPostingPlant;

  requestBuilder(): MaintainInventoryPostingPlantRequestBuilder<DeSerializersT> {
    return new MaintainInventoryPostingPlantRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof MaintainInventoryPostingPlant,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    ...
    SIBLING_ENTITY: OneToOneLink<
      ...
      MaintainInventoryPostingPlantApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<MaintainInventoryPostingPlant<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', MaintainInventoryPostingPlant)
      };
    }
