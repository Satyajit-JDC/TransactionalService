...
import type { MaintainMovementTypeToTransactionCategoryImpactApi } from './MaintainMovementTypeToTransactionCategoryImpactApi';
import {
...
/**
 * This class represents the entity "MaintainMovementTypeToTransactionCategoryImpact" of service "RegulationComplianceMasterService".
 */
export class MaintainMovementTypeToTransactionCategoryImpact<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements MaintainMovementTypeToTransactionCategoryImpactType<T>
{
  /**
   * Technical entity name for MaintainMovementTypeToTransactionCategoryImpact.
   */
  static _entityName = 'MaintainMovementTypeToTransactionCategoryImpact';
  /**
   * Default url path for the according service.
   */
  static _defaultBasePath = '/service/RegulationComplianceMasterService';
  /**
   * All key fields of the MaintainMovementTypeToTransactionCategoryImpact entity
   */
  ...
  /**
   * One-to-one navigation property to the {@link MaintainMovementTypeToTransactionCategoryImpact} entity.
   */
  declare siblingEntity?: MaintainMovementTypeToTransactionCategoryImpact<T> | null;

  constructor(
    _entityApi: MaintainMovementTypeToTransactionCategoryImpactApi<T>
  ) {
    super(_entityApi);
  }
}

export interface MaintainMovementTypeToTransactionCategoryImpactType<
  T extends DeSerializers = DefaultDeSerializers
> {
  ...
  siblingEntity?: MaintainMovementTypeToTransactionCategoryImpactType<T> | null;
}
