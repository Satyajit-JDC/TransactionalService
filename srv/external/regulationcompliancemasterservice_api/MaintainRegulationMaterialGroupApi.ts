...
import { MaintainRegulationMaterialGroupRequestBuilder } from './MaintainRegulationMaterialGroupRequestBuilder';
...
export class MaintainRegulationMaterialGroupApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<MaintainRegulationMaterialGroup<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new MaintainRegulationMaterialGroupApi(deSerializers);
  }

  private navigationPropertyFields!: {
    /**
     * Static representation of the one-to-many navigation property {@link manageRegulationTypeAndObjectCategory} for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    MANAGE_REGULATION_TYPE_AND_OBJECT_CATEGORY: OneToManyLink<
  ...
  _addNavigationProperties(
    ...
    this.navigationPropertyFields = {
      MANAGE_REGULATION_TYPE_AND_OBJECT_CATEGORY: new OneToManyLink(
  ...
  entityConstructor = MaintainRegulationMaterialGroup;

  requestBuilder(): MaintainRegulationMaterialGroupRequestBuilder<DeSerializersT> {
    return new MaintainRegulationMaterialGroupRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof MaintainRegulationMaterialGroup,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    ID: OrderableEdmTypeField<
      MaintainRegulationMaterialGroup<DeSerializers>,
      DeSerializersT,
      'Edm.Guid',
      false,
      true
    ...
    SIBLING_ENTITY: OneToOneLink<
      ...
      MaintainRegulationMaterialGroupApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<MaintainRegulationMaterialGroup<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', MaintainRegulationMaterialGroup)
      };
    }
