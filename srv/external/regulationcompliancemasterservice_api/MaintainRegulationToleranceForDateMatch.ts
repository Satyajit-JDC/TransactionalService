...
import type { MaintainRegulationToleranceForDateMatchApi } from './MaintainRegulationToleranceForDateMatchApi';
import {
...
/**
 * This class represents the entity "MaintainRegulationToleranceForDateMatch" of service "RegulationComplianceMasterService".
 */
export class MaintainRegulationToleranceForDateMatch<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements MaintainRegulationToleranceForDateMatchType<T>
{
  /**
   * Technical entity name for MaintainRegulationToleranceForDateMatch.
   */
  static _entityName = 'MaintainRegulationToleranceForDateMatch';
  /**
   * Default url path for the according service.
   */
  static _defaultBasePath = '/service/RegulationComplianceMasterService';
  /**
   * All key fields of the MaintainRegulationToleranceForDateMatch entity
   */
   ...
   * @nullable
   */
  declare noOfDays?: DeserializedType<T, 'Edm.Int32'> | null;
  /**
   * Is Active Entity.
   */
  ...
  /**
   * One-to-one navigation property to the {@link MaintainRegulationToleranceForDateMatch} entity.
   */
  declare siblingEntity?: MaintainRegulationToleranceForDateMatch<T> | null;

  constructor(_entityApi: MaintainRegulationToleranceForDateMatchApi<T>) {
    super(_entityApi);
  }
}

export interface MaintainRegulationToleranceForDateMatchType<
  T extends DeSerializers = DefaultDeSerializers
> {
  ...
  noOfDays?: DeserializedType<T, 'Edm.Int32'> | null;
  ...
  siblingEntity?: MaintainRegulationToleranceForDateMatchType<T> | null;
}
