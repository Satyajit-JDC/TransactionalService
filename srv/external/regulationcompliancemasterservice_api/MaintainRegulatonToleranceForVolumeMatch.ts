...
import type { MaintainRegulatonToleranceForVolumeMatchApi } from './MaintainRegulatonToleranceForVolumeMatchApi';
import {
...
/**
 * This class represents the entity "MaintainRegulatonToleranceForVolumeMatch" of service "RegulationComplianceMasterService".
 */
export class MaintainRegulatonToleranceForVolumeMatch<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements MaintainRegulatonToleranceForVolumeMatchType<T>
{
  /**
   * Technical entity name for MaintainRegulatonToleranceForVolumeMatch.
   */
  static _entityName = 'MaintainRegulatonToleranceForVolumeMatch';
  /**
   * Default url path for the according service.
   */
  static _defaultBasePath = '/service/RegulationComplianceMasterService';
  /**
   * All key fields of the MaintainRegulatonToleranceForVolumeMatch entity
   */
  ...
  /**
   * One-to-one navigation property to the {@link MaintainRegulatonToleranceForVolumeMatch} entity.
   */
  declare siblingEntity?: MaintainRegulatonToleranceForVolumeMatch<T> | null;

  constructor(_entityApi: MaintainRegulatonToleranceForVolumeMatchApi<T>) {
    super(_entityApi);
  }
}

export interface MaintainRegulatonToleranceForVolumeMatchType<
  T extends DeSerializers = DefaultDeSerializers
> {
  ...
  siblingEntity?: MaintainRegulatonToleranceForVolumeMatchType<T> | null;
}
