...
import { MaintainCompanyIdToPlantMappingRequestBuilder } from './MaintainCompanyIdToPlantMappingRequestBuilder';
import {
  CustomField,
...
export class MaintainCompanyIdToPlantMappingApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<MaintainCompanyIdToPlantMapping<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): MaintainCompanyIdToPlantMappingApi<DeSerializersT> {
    return new MaintainCompanyIdToPlantMappingApi(deSerializers);
  }
  ...
  _addNavigationProperties(
    linkedApis: [MaintainCompanyIdToPlantMappingApi<DeSerializersT>]
  ): this {
  ...
  entityConstructor = MaintainCompanyIdToPlantMapping;

  requestBuilder(): MaintainCompanyIdToPlantMappingRequestBuilder<DeSerializersT> {
    return new MaintainCompanyIdToPlantMappingRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof MaintainCompanyIdToPlantMapping,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    ID: OrderableEdmTypeField<
      MaintainCompanyIdToPlantMapping<DeSerializers>,
      DeSerializersT,
      'Edm.Guid',
      false,
      true
    ...
    SIBLING_ENTITY: OneToOneLink<
      ...
      MaintainCompanyIdToPlantMappingApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<MaintainCompanyIdToPlantMapping<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', MaintainCompanyIdToPlantMapping)
      };
    }
