...
import type { MaintainTransactionTypeApi } from './MaintainTransactionTypeApi';

/**
 * This class represents the entity "MaintainTransactionType" of service "RegulationComplianceMasterService".
 */
export class MaintainTransactionType<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements MaintainTransactionTypeType<T>
{
  /**
   * Technical entity name for MaintainTransactionType.
   */
  static _entityName = 'MaintainTransactionType';
  /**
   ...
   */
  declare siblingEntity?: MaintainTransactionType<T> | null;

  constructor(_entityApi: MaintainTransactionTypeApi<T>) {
    super(_entityApi);
  }
}
...
> {
  ...
  siblingEntity?: MaintainTransactionTypeType<T> | null;
}
