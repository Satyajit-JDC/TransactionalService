...
import { MaintainRegulationTransactionTypeTsRequestBuilder } from './MaintainRegulationTransactionTypeTsRequestBuilder';
...
export class MaintainRegulationTransactionTypeTsApi<
    ...
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): MaintainRegulationTransactionTypeTsApi<DeSerializersT> {
    return new MaintainRegulationTransactionTypeTsApi(deSerializers);
  }
  ...
  entityConstructor = MaintainRegulationTransactionTypeTs;

  requestBuilder(): MaintainRegulationTransactionTypeTsRequestBuilder<DeSerializersT> {
    return new MaintainRegulationTransactionTypeTsRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof MaintainRegulationTransactionTypeTs,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    ID: OrderableEdmTypeField<
      MaintainRegulationTransactionTypeTs<DeSerializers>,
      DeSerializersT,
      'Edm.Guid',
      false,
      true
    ...
    SIBLING_ENTITY: OneToOneLink<
      ...
      MaintainRegulationTransactionTypeTsApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<MaintainRegulationTransactionTypeTs<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', MaintainRegulationTransactionTypeTs)
      };
    }
